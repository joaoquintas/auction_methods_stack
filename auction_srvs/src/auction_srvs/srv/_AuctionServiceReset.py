"""autogenerated by genmsg_py from AuctionServiceResetRequest.msg. Do not edit."""
...
class AuctionServiceResetRequest(roslib.message.Message):
  _md5sum = "71cdc8b8f8b1a628ff5e78f4bb4202a8"
  _type = "auction_srvs/AuctionServiceResetRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AuctionServiceResetRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from AuctionServiceResetResponse.msg. Do not edit."""
import roslib.message
import struct


class AuctionServiceResetResponse(roslib.message.Message):
  _md5sum = "3807fca4b87e6d8139990870471dd195"
  _type = "auction_srvs/AuctionServiceResetResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AuctionServiceResetResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_I = roslib.message.struct_I
class AuctionServiceReset(roslib.message.ServiceDefinition):
  _type          = 'auction_srvs/AuctionServiceReset'
  _md5sum = '4c61db6a7e5400f7a5137a2c8194bac9'
  _request_class  = AuctionServiceResetRequest
  _response_class = AuctionServiceResetResponse
